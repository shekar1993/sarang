...
<section class="footer-image">
    <div class="container-fluid d-flex justify-content-center align-items-end h-100">
        <div class="row container d-flex justify-content-center align-items-end">
            <div class="col-md-4 "><p>
                    <span id="footer-heading" >Sarang Music</span><br>
                    +91 9590669510 / hello@sarangmusic.com<br>
                    Careers <br>
                    All Rights Reserved 2019 Sarang Music
                </p>
            </div>

            <div class="col-md-4 text-left" id="footer-sec2"><p>
                    Sign up for our mailing list <br> to get
                    latest updates and offers </p><br><br>
                <input type="text" class="place" placeholder=" Your Email ID " name="search">
                <button class="button2" type="submit">Submit</button>
            </div>

            <div class="col-md-4" id="footer-sec3"><p class="align-bottom">
                    OUR  STORY   |   TEAM   |   JOIN US </p>
            </div>
...
<script src="<?php echo base_url();
?>public/js/slick-slider.min.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    $('.item1').click(function (e) {
            var showText= $(this).find('img').attr("alt");
            var link= $(this).find('img').attr("title");
            $('.desc #ptag').text(showText);
           $('.link').attr('href',link);
        });
    });
